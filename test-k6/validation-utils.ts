...
import { extractQueryNameFromGroup } from './utils.ts'

const logError = (validationCheck: string) => {
    // eslint-disable-next-line no-console
    console.error('\x1b[31m', `Error for ${extractQueryNameFromGroup()} query in '${exec.scenario.name}' scenario. ${validationCheck}`)
}
